...
panels = json.loads(Path('node_modules/.tmp/tree-quality-preview.json').read_text())
scale = 2
image = Image.new('RGB', (1200 * scale, 2268 * scale), '#f2eee3')
...
text(32, 22, 'GODBOX / tree architecture study', 32)
text(32, 70, 'Seed: botanical-preview / unmodified mesh geometry, fixed lighting and cameras.', 17)
...
text(32, 2230, 'Offline mesh QA / lighting, shader bark detail and shadows require the WebGL acceptance scene.', 13)
image.resize((1200, 2268), Image.Resampling.LANCZOS).save('docs/tree-quality-preview.png')
print('Wrote docs/tree-quality-preview.png')
