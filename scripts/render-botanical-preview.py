...
panels = json.loads(Path('node_modules/.tmp/botanical-preview.json').read_text())
scale = 2
image = Image.new('RGB', (1200 * scale, 1000 * scale), '#f2eee3')
...
text(32, 22, 'GODBOX / botanical detail study', 32)
text(32, 70, 'Production meshes / folded petals, layered leaves and feathered ferns.', 17)
...
text(32, 970, 'Offline geometry QA / controlled fixture. Browser lighting, wind and shadows require a live visual pass.', 13)
image.resize((1200, 1000), Image.Resampling.LANCZOS).save('docs/botanical-detail-preview.png')
print('Wrote docs/botanical-detail-preview.png')
